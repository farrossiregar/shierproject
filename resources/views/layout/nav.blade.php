...
<div style="width: 100vw; overflow: hidden;">
    ...
    <div style="width: 100vw; overflow: hidden;">
        <nav class="navbar navbar-inverse" style="margin-bottom: 0px; margin-top: 0px; width: 100vw; overflow: hidden; position: fixed; z-index: 1000;">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            <div>
                                <a href="{{ route('/') }}">
                                    <img src="{{ asset('image/shierproject-logo-darkgrey-rect-nav.png') }}" alt="" style="width: 130px;">
                                </a>
                            </div>
                        </ul>
