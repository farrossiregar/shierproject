...
@section('content')
  ...
  <?php
    if($foto_name != ''){
  ?>
    <div style="overflow: hidden; margin-top: -20px; background-image: url('<?php echo "http://cms.shierproject.com/image/content/".$foto_name; ?>'); height: 65vh; width: 100vw; background-position: center; ">
